...
import com.tyga.fintech.databinding.ActivityOtpRegisterMerchantBinding;
...
public class OtpRegisterMerchantActivity extends AppCompatActivity {

    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks;
    ActivityOtpRegisterMerchantBinding binding;
    ProgressDialog progressDialog;
    ProgressDialog progressDialogVerifiying;
    private PhoneAuthProvider.ForceResendingToken mResendToken;
    private String mVerificationId;

    private String nama, alamat, telepon, password, lpd, no_hp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_otp_register_merchant);
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Toast.makeText(OtpRegisterMerchantActivity.this,"Registration Error ! "+e.toString(), Toast.LENGTH_LONG);
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    Log.d("RegisterPecandu",e.getMessage());
                } else if (e instanceof FirebaseTooManyRequestsException) {
                    Toast.makeText(OtpRegisterMerchantActivity.this, "Quota exceeded", Toast.LENGTH_LONG).show();
                    Log.d("RegisterPecandu",e.getMessage());
                }
            }
    ...
    private void insertRegister(){
        ApiClient.createService(ApiService.class)
                .registerMerchant(alamat, nama, no_hp, password, lpd, "2")
                .enqueue(new Callback<ResponseMessage>() {
                    @Override
                    public void onResponse(Call<ResponseMessage> call, Response<ResponseMessage> response) {
//                        progressDialogVerifiying.dismiss();
                        Toast.makeText(OtpRegisterMerchantActivity.this,"Register Berhasil",Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(OtpRegisterMerchantActivity.this, LoginActivity.class);
